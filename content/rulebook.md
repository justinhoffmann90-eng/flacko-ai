...
3. Knowing when to reduce exposure decisively (Master Eject ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â partial exit, not full liquidation)
...
**Why it matters:** The Slow Zone creates a graduated response between "normal accumulation" and "Master Eject." It slows you down when price is weakening without forcing you to sit in cash and miss early recovery moves.
...
**The exceptions:**
- **Master Eject is always immediate.** Daily close below your eject level = partial exit (sell leverage, trim to 50%), regardless of mode.
...
After a Master Eject, you're holding a 50% core TSLA position with no leverage. The recovery paths determine when you can begin rebuilding above 50%.
...
| **Master Eject Triggered** | 0% ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no buying | Capital preservation mode. Cash is a position. |
...
| ORANGE (40%) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ RED (20%) | **Strong suggestion** | Actively work toward 20-30% invested. Trim into any bounces using the 30% trim cap. You should be getting lighter over days, not in one panic sell. Structure is broken ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â don't ride full exposure waiting for Master Eject. |
...
**The hard line is Master Eject.** Everything above it is guided. Master Eject is mandatory.
...
Master Eject Level Breaks (Weekly 21 EMA, 2 consecutive closes)
...
| Core Hold | -- | -- | 51 (never sold unless Master Eject or thesis breaks) |
...
- **Master Eject triggers** -- non-negotiable, same as buy side
...
- Mode downgrades
- Daily red candles
- General market weakness (unless Master Eject level breaks)
...
| Non-negotiable floor | Master Eject (partial exit ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sell leverage, trim to 50%) | Core Hold (never sell unless thesis breaks or Master Eject) |
...
Master Eject (W21, 2 closes): Sell all leverage. Trim TSLA to 50%. Oversold override active.
```
...
10. **Master Eject is a partial exit, not a liquidation** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Sell all leverage, trim TSLA to 50%. Weekly 21 EMA, 2 consecutive closes.
...
12. **Downgrade exposure reduction is guided** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â GREENÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢YELLOW: no action needed. YELLOWÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ORANGE: soft recommendation to reduce. ORANGEÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢RED: strong suggestion to actively trim. Master Eject: mandatory.
...
17. **Protect the Core Hold** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Whatever remains after all trim levels is only sold on Master Eject or thesis break
