...
function cleanContent(raw: string): string {
  ...
  // Also remove standalone date lines without ## prefix
  cleaned = cleaned.replace(/^(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday),?\s+\w+\s+\d{1,2},?\s+\d{4}\s*$/gm, '');
