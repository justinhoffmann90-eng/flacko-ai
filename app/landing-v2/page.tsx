      ...
      <section className="py-6 px-6 border-t border-zinc-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-50 hover:opacity-70 transition-opacity">
            ...
            {/* Reuters */}
            <div className="flex items-center gap-2 text-zinc-500 hover:text-[#FF8000] transition-colors">
            ...
            {/* Yahoo Finance */}
            <div className="flex items-center gap-2 text-zinc-500 hover:text-[#720e9e] transition-colors">
