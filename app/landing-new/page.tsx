      ...
      <section className="py-6 px-6 border-t border-zinc-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-60">
            {/* Discord */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#5865F2] transition-colors">
            ...
            {/* SpotGamma */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#00D4AA] transition-colors">
            ...
            {/* FS Insight */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#FF6B35] transition-colors">
            ...
            {/* CNBC */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#005594] transition-colors">
            ...
            {/* Reuters */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#FF8000] transition-colors">
              ...
              <span className="text-xs font-medium hidden sm:inline">Reuters</span>
            </div>
            {/* TradingView */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#2962FF] transition-colors">
            ...
            {/* Yahoo Finance */}
            <div className="flex items-center gap-2 text-zinc-400 hover:text-[#720e9e] transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12.736 2L7.047 12.5l.654 1.145L12.5 6.65l4.764 8.35H12.5l-.654 1.145L7.047 22h3.272l2.181-3.855L14.681 22h3.272l-4.799-8.355L17.953 2h-3.272l-1.945 3.41L10.791 2z"/></svg>
              <span className="text-xs font-medium hidden sm:inline">Yahoo</span>
            </div>
          </div>
        </div>
      </section>
