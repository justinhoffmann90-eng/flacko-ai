...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|manifest.json|robots.txt|sitemap.xml|api/price-cache|api/cron|api/backtest|api/reports/reparse|api/emails|backtest|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|json|html)$).*)",
  ],
};
